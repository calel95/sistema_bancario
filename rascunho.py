...
#         cria_conta_corrente(agencia=agencia,numero_conta=conta, usuario=usuario_da_conta)
#     if opcao == 6:
#          print(usuarios)
#          for i in usuarios:
#               print(i)
...
txt = [('Calel', '19/01/01', '11111', {'endereco' : 'Luizito, 31 - Florida - Goiania/MJ'}), ('Calel', '19/01/01', '22222', {'endereco' : 'Luizito, 31 - Florida - Goiania/MJ'})]
